...
v_char <- c("dog")
v_num <- c(1,2,3,4)
v_integer <- c(10L, 20L, 30L)
v_logic <- c(TRUE, FALSE)
...
```{r question_4}
# your code here
odd_ratio = (cheesecake_exposure[c(1)] * cheesecake_exposure[c(4)]) / 
(cheesecake_exposure[c(2)] * cheesecake_exposure[c(3)])
odd_ratio```
...
```{r question_9}
# your code here
if(odd_ratio>1){print("greater than 1")} else {print("not greater than 1")}
